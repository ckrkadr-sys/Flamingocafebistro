...
export const dictionaries = {
  tr: {
    ...
    home: {
      ...
      featureItems: [
        {
          title: "Yerel his",
          description: "Çalış Sahil ziyaretinin parçası olan sıcak bir durak.",
        },
        {
          title: "Taze ve dengeli",
          description: "Kahve, yemek, tatlı ve içecekleri aynı akışta düşünür.",
        },
        {
          title: "Ziyarete hazır",
          description: "Fiyatlı menü, telefon ve yol tarifi hızlıca görünür.",
        },
        {
          title: "İyi atmosfer",
          description: "Sıcak servis hissi ve gün batımına yakışan cafe-bistro dili.",
        },
      ],
      ...
      headerCtaLabel: "Ziyareti planla",
      heroDescription: "Fiyatlı menüyü inceleyin, kahve ve bistro lezzetlerine göz atın, Çalış Sahil'deki konuma kolayca ulaşın.",
      heroFallbackAction: "İletişime geç",
      heroImageLabel: "Flamingo Cafe&Bistro ana görsel alanı",
      heroMoodBadgeBottom: "Gün boyu",
      heroMoodBadgeMiddle: "İyi mod",
      heroMoodBadgeTop: "Kahve",
      heroPanelLine1: "İyi ye",
      heroPanelLine2: "Biraz",
      heroPanelLine3: "Kal",
      heroPrimaryAction: "Menüyü gör",
      heroRibbonLabel: "Mahallenin bistrosu",
  ...
  en: {
    ...
    home: {
      ...
      featureItems: [
        {
          title: "Locally loved",
          description: "A warm stop that belongs to the Çalış Beach visit.",
        },
        {
          title: "Fresh and balanced",
          description: "Coffee, food, desserts and drinks in one easy flow.",
        },
        {
          title: "Made for visits",
          description: "Priced menu, phone and directions stay easy to reach.",
        },
        {
          title: "Good vibes only",
          description: "Warm service energy and a cafe-bistro language made for sunsets.",
        },
      ],
      ...
      headerCtaLabel: "Plan visit",
      heroDescription: "Browse the priced menu, explore coffee and bistro flavors, and reach the Çalış Beach location quickly.",
  ...
  ru: {
    ...
    home: {
      ...
      featureItems: [
        {
          title: "Локальное настроение",
          description: "Теплая остановка, которая подходит визиту к пляжу Чалыш.",
        },
        {
          title: "Свежо и сбалансировано",
          description: "Кофе, еда, десерты и напитки в одном удобном потоке.",
        },
        {
          title: "Для визита",
          description: "Меню с ценами, телефон и маршрут остаются рядом.",
        },
        {
          title: "Хорошее настроение",
          description: "Теплая энергия сервиса и язык кафе-бистро для закатов.",
        },
      ],
      ...
      headerCtaLabel: "План визита",
      heroDescription: "Посмотрите меню с ценами, откройте кофейные и бистро-вкусы и быстро перейдите к локации у пляжа Чалыш.",
      ...
      heroPanelLine1: "Ешьте вкусно",
      heroPanelLine2: "Останьтесь",
      heroPanelLine3: "Подольше",
      heroPrimaryAction: "Смотреть меню",
      heroRibbonLabel: "Ваше бистро рядом",
  ...
  de: {
    ...
    home: {
      ...
      featureItems: [
        {
          title: "Lokales Gefühl",
          description: "Ein warmer Stopp, der zum Besuch am Çalış Strand passt.",
        },
        {
          title: "Frisch und ausgewogen",
          description: "Kaffee, Speisen, Desserts und Getränke in einem klaren Ablauf.",
        },
        {
          title: "Besuchsbereit",
          description: "Menü mit Preisen, Telefon und Route bleiben schnell erreichbar.",
        },
        {
          title: "Gute Stimmung",
          description: "Warme Service-Energie und eine Cafe-Bistro-Sprache für Sonnenuntergänge.",
        },
      ],
      ...
      headerCtaLabel: "Besuch planen",
      heroDescription: "Sehen Sie das Menü mit Preisen an, entdecken Sie Kaffee und Bistro-Aromen und finden Sie schnell den Standort am Çalış Strand.",
      ...
      heroMoodBadgeMiddle: "Gute Laune",
      heroMoodBadgeTop: "Kaffee",
      heroPanelLine1: "Gut essen",
      heroPanelLine2: "Bleiben",
      heroPanelLine3: "Noch etwas",
      heroPrimaryAction: "Menü ansehen",
      heroRibbonLabel: "Ihr Bistro in der Nähe",
